<h1 align="center">Hi, I'm Tema 👋</h1>

<p align="center">
  <b>Full-stack developer</b> — Python / FastAPI · React · TypeScript
  <br/>
  I build real products end to end: backend, frontend, applied crypto, infra.
</p>

<p align="center">
  <a href="mailto:mauwpawork@gmail.com"><img src="https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white" alt="Email"/></a>
  <a href="https://t.me/MauwpaL"><img src="https://img.shields.io/badge/Telegram-2CA5E0?logo=telegram&logoColor=white" alt="Telegram"/></a>
</p>
...
- 🛠 I build products end to end — FastAPI/SQLite backends, React 19 + TypeScript frontends, Docker & CI.
- 🔐 I enjoy applied cryptography: end-to-end encryption, BIP39 key derivation, signed challenge/response auth.
- 🎮 On the side I tinker with game dev in Unity / C#.
- 🧪 I care about clean, tested code — SOLID / DRY / KISS, CI on every push, honest docs.
- 🌍 EN / RU.
